AMD 3D V-Cache Perfomance Optimizer
===================================
Version 1.0.0.7
...
Description
-------------------------
This driver supports the AMD 3D V-Cache Perfomance Optimizer on AMD Ryzen based Desktop chipsets.
...
4. There should be a device in the section named "Other Devices" with name "Unknown Device", with Hardware Id as *ACPI\AMDI0101*.
...
2. Select "Classic View" from the left pane.
3. Invoke Device Manager. 
4. There should be a device section named "AMD 3D V-Cache Perfomance Optimizer"
5. Right-click on AMD 3D V-Cache Perfomance Optimizer, and click on "Update Driver".
6. Select "Browse my computer for driver software".
7. Click "Browse" to choose the installation files and click "OK".
8. A box will appear: "The wizard has finished installing the software", click "Finish" to complete the installation.
...
3. Invoke Device Manager. 
4. There should be a device section named "AMD 3D V-Cache Perfomance Optimizer".
5. Right-click on the “AMD 3D V-Cache Perfomance Optimizer”, and click on "Uninstall".
