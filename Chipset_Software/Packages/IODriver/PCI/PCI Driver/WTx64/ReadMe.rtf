...
1) Invoke Device Manager. 
2) Look for the hardware with device ID 0x145A, 0x1455, 0x1485, 0x148A, 0x14DE
3) Right-click on the device and click on "Update Driver".
4) Select "Browse my computer for driver software".
5) Click "Browse" to choose the installation files and click "OK".

Uninstallation:
---------------
1) Invoke Device Manager. 
2) Look for the hardware with device ID 0x145A, 0x1455, 0x1485, 0x148A, 0x14DE
3) Right-click on the device and click on "Uninstall Driver".
